...
typedef enum halide_target_feature_t {
    ...
    halide_target_feature_wasm_simd_128,  ///< Enable +simd128 instructions for WebAssembly codegen.
    halide_target_feature_wasm_threads,  ///< Enable threads + atomics for WebAssembly codegen.
